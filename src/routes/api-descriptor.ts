...
const AI_ENDPOINTS: EndpointDescriptor[] = [
  // Tools
  {
    method: "GET",
    path: "/api/ai/tools",
    description: "List installed AI tools and their status",
  },
  ...
  },
  {
    ...
    body: {
      ...
      tags: { type: "string[]", required: false, description: "Tags array" },
    },
  },
  {
    method: "PUT",
  ...
  {
    method: "POST",
    path: "/api/ai/prompts/:id/render",
    description: "Render template with variables",
    body: {
      variables: {
        type: "object",
        required: true,
        description: "Key-value map of variable values",
      },
    },
  },
  ...
  {
    method: "GET",
    path: "/api/ai/contexts",
    description: "List context pieces",
    parameters: {
  ...
  {
    method: "GET",
    path: "/api/ai/contexts/:id",
    description: "Get a context piece by ID",
  },
  {
    method: "POST",
    path: "/api/ai/contexts",
    description: "Create a context piece",
    body: {
      ...
      type: {
        ...
        required: true,
        description:
          "Type: git_repo|api_call|markdown_doc|command|plain_text|file|url",
      },
      content: {
        type: "string",
        required: true,
  ...
  },
  {
    method: "PUT",
    path: "/api/ai/contexts/:id",
    description: "Update a context piece",
  },
  {
    method: "DELETE",
    path: "/api/ai/contexts/:id",
    description: "Delete a context piece",
  },
  ...
  {
    method: "GET",
    path: "/api/ai/sessions/providers",
  ...
  },
  {
    ...
    body: {
      ...
      agentType: {
        type: "string",
        required: true,
        description: "Agent type (claude, codex, etc.)",
      },
      config: {
        type: "object",
        required: false,
  ...
  {
    method: "POST",
    path: "/api/ai/sessions/:id/send",
    description: "Send a prompt to a session",
    body: {
      prompt: { type: "string", required: true, description: "Prompt content" },
      contexts: {
        type: "array",
        required: false,
        description: "Context objects to include",
      },
    },
  },
  {
    method: "GET",
    path: "/api/ai/sessions/:id/logs",
  ...
  {
    method: "GET",
    path: "/api/ai/sessions/:id/stats",
    description: "Get session usage stats",
  },
  {
    method: "PUT",
    path: "/api/ai/sessions/:id/config",
  ...
  {
    method: "POST",
    path: "/api/ai/dispatch/compose",
    description: "Compose a prompt from template + vars + contexts",
  },
  {
    method: "POST",
    path: "/api/ai/dispatch/send",
    description: "Dispatch a prompt to a session",
  },
  {
    method: "GET",
    path: "/api/ai/dispatch/history",
    description: "View dispatch history",
  },
  {
    method: "GET",
    path: "/api/ai/dispatch/:id",
    description: "Get dispatch details",
  },
  ...
  {
    method: "POST",
    path: "/api/ai/queue/enqueue",
    description: "Add item to queue",
  },
  { method: "GET", path: "/api/ai/queue/:id", description: "Get queue item" },
  {
    method: "POST",
    path: "/api/ai/queue/:id/cancel",
    description: "Cancel queue item",
  },

  // Stats
  {
    method: "GET",
    path: "/api/ai/stats/overview",
    description: "Aggregated usage overview",
  },
  {
    method: "GET",
    path: "/api/ai/stats/sessions/:id",
    description: "Per-session stats",
  },
  {
    method: "GET",
    path: "/api/ai/stats/usage",
